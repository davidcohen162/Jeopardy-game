...
//    categories starting from the offset number.
    public static final String offsetQuery = "offset";
    ...
    public void setCountAmount(int count) {
    ...
    public void setOffsetAmount(int offsetAmount) {
        addParameterQuery(CategoriesJson.countQuery, Integer.toString(offsetAmount));
    }
